...
const Results = () => {
  ...
  return (
    <div className="bg-gray-100 mt-20 min-h-[90vh] grid place-items-center p-8 rounded-lg shadow-lg max-w-4xl mx-auto">
    ...
    <div className="bg-white p-6 rounded-lg shadow flex flex-col md:flex-row items-start gap-8">
      ...
      <div className="flex-1">
        ...
        <p className="text-gray-600 mt-4">
          Association of Chartered Certified Accountants are professionals responsible for financial 
          management, reporting, auditing, taxation, and other financial aspects of business. They have 
          global recognition and are highly sought after in the finance industry.
        </p>
      </div>
